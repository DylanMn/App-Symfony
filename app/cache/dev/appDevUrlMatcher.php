...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/vote')) {
            // voteup
            if (0 === strpos($pathinfo, '/voteup') && preg_match('#^/voteup/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'voteup')), array (  '_controller' => 'AppBundle\\Controller\\DefaultController::voteUpAction',));
            }

            // votedown
            if (0 === strpos($pathinfo, '/votedown') && preg_match('#^/votedown/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'votedown')), array (  '_controller' => 'AppBundle\\Controller\\DefaultController::voteDownAction',));
            }
        ...
        // rated
        if ($pathinfo === '/best') {
            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::showRatedBest',  '_route' => 'rated',);
        }

        // rateds
        if ($pathinfo === '/worst') {
            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::showRatedWorst',  '_route' => 'rateds',);
        }
        ...
        if (0 === strpos($pathinfo, '/categorie') && preg_match('#^/categorie/(?P<categorie>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'categorie')), array (  '_controller' => 'AppBundle\\Controller\\DefaultController::showCategorie',));
        }
